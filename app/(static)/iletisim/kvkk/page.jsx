...
export default function StaticPage() {
  return (
    <>
      ...
      <PageContent h2Title="Aydınlatma Metni" addClass="text-gray-600">
        ...
        <p>
          ...
          yöntemlerle toplanabilir. Kişisel verilerinizin işlenmesi, KVKK'nın 5.
          ve 6. maddelerinde belirtilen hukuki sebepler doğrultusunda
          gerçekleştirilir.
        </p>
        ...
        <ul>
          ...
          <li>
            KVKK’nın 7. maddesi uyarınca kişisel verilerinizin silinmesini veya
        ...
        <p>
          ...
          ilgili mevzuatın öngördüğü süre kadar saklanır. Bu sürelerin sonunda,
          kişisel verileriniz KVKK'ya uygun olarak silinir, yok edilir veya
        ...
        <p>
          ...
          almaktayız. Ancak, internetin doğası gereği tamamen güvenli bir ortam
          sağlamanın mümkün olmadığını unutmamanız gerekir.
        </p>
