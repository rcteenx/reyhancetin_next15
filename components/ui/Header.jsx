  ...
  return (
    <header className="mx-auto container-p max-w-7xl pt-2 flex items-center justify-between ">
      ...
      >
        ...
        <div className="px-2 py-0  sm:py-1 bg-slate-100 rounded-xl border">
          <h3 className="my-1 sm:my-2 font-light text-left text-base md:text-3xl leading-6  ">
            Reyhan Çetin
          </h3>
          <p className="mt-1 font-light text-2xs sm:text-base tracking-tight hidden sm:block sm:border-t border-indigo">
